...
We use Mininet on Amazon EC2 to create a simulated network, design network layout, and choose our own network bandwidth and delay. Then we re-create the results in this paper. We test the low-rate DoS attacks in four scenarios depicted in the graph below.
